const I18N = {
  zh: {
    ...
    "bankroll.loadingOdds": "正在拉取实时赔率并计算方案（约需数秒）...",
  ...
  en: {
    ...
    "bankroll.loadingOdds": "Fetching live odds and building plan (may take a few seconds)...",
